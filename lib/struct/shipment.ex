defmodule ExCheckout.Shipment.Struct do
  @moduledoc """
  ...
  alias ExCheckout.Shipment.Struct, as: Shipment
  alias ExCheckout.Address.Struct, as: Address
  alias ExCheckout.Package.Struct, as: Package
